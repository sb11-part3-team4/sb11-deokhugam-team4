...
@Entity
@Table(name = "deleted_book", uniqueConstraints = {
    @UniqueConstraint(name = "uk_book_isbn", columnNames = "isbn")
})
@Getter
@NoArgsConstructor(access = AccessLevel.PROTECTED)
@EntityListeners(AuditingEntityListener.class)
public class DeletedBook extends BaseEntity {
  ...
  // ===== 생성 =====
  @Builder
  public DeletedBook(UUID id, Instant createdAt, Instant updatedAt,String title, String author, String description, String publisher,
      LocalDate publishedDate, String isbn, String thumbnailUrl, int reviewCount, BigDecimal rating) {

    super(id, createdAt, updatedAt);  // BaseEntity 생성자 호출
  ...
  //Book -> DeletedBook
  public static DeletedBook from(Book book) {
    return DeletedBook.builder()
        .id(book.getId())
